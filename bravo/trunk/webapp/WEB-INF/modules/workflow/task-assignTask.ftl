<@bravo.Page name="TaskInstanceManager" title="处理中任务管理">
	<@bravo.Viewport  layout="border">
		<@bravo.FormPanel name="taskInstance_find" tbar="Toolbar" region="north"  frame="true" autoScroll="true" height="130" width="750"  title="处理中任务查询" collapsible="true"  >  
		...
		<@bravo.GridPanel  region="center"  stripeRows="true"  name="taskInstance_grid"  dataProxy="./taskBaseDomain!findAndRendJsonData.action?taskInstance.isSuspended=0&taskInstance.isOpen=1&taskInstance.actorId=%{requestHandler.currentUser.id?c}&taskInstance.end_restriction=isNull"  contextDataName="taskInstances" collapsible="true" >  
