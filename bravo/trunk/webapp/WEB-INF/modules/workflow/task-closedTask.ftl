<@bravo.Page name="TaskInstanceManager" title="已结束任务管理">
	<@bravo.Viewport  layout="border">
		<@bravo.FormPanel name="taskInstance_find" tbar="Toolbar" region="north"  frame="true" autoScroll="true" height="130" width="750"  title="已结束任务查询列表" collapsible="true"  >  
		...
		<#---- 
		<@bravo.GridPanel  region="center"  height="370"  region="south"  name="taskInstance_grid"  dataProxy="./task!assignTasks.action?processInstance.end_restriction=isNotNull&isSuspended=0&isOpen=1&pooledActors.id=%{requestHandler.currentUser.id}"  contextDataName="taskInstances" collapsible="true" >  
		...
		---->		
		<@bravo.GridPanel  region="center" stripeRows="true"   name="taskInstance_grid"  dataProxy="./taskBaseDomain!findAndRendJsonData.action?taskInstance.isSuspended=0&taskInstance.isOpen=0&taskInstance.actorId=%{requestHandler.currentUser.id?c}&taskInstance.end_restriction=isNotNull&taskInstance.processInstance.end_restriction=isNotNull"  contextDataName="taskInstances" collapsible="true" >  
			<@bravo.Column hidden="true" name="id" header="ID" width="176"  sortable="true"  resizable="true"/>
