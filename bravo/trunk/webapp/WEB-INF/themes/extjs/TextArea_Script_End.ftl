    var ${component.name} = new Ext.form.TextArea({
	...
	</#if><#if component.preventScrollbars?exists>,preventScrollbars:${component.preventScrollbars}
	</#if><#if component.TextArea?exists>,TextArea:${component.TextArea}
	</#if><#if component.autoSize?exists>,autoSize:${component.autoSize}
	</#if>
