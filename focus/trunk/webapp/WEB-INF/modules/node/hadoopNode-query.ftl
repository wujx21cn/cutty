<@bravo.Page name="hadoopNodeManager" title="Hadoop节点管理" >
	<@bravo.Viewport  layout="border">
			...
			<@bravo.Toolbar name="Toolbar" valign="top">
				...
				<@bravo.FieldSet labelWidth="80" cols="2;1,1;1,1" rows="1;1,1;1,1" >		
					...
					<@bravo.ComboBox name="nodeType.id" fieldLabel="节点类型" width="160" editable="false" dataProxy="hql[from Enumeration where enumType.id=15]" displayField="name" valueField="id" />
			 ...
			 <@bravo.GridPanel name="hadoopNode_Grid" region="center" tbar="Toodddlbar" contextDataName="users" stripeRows="true" dataProxy="./hadoopNode!findAndRendJsonData.action"  collapsible="true" split="true" >
