<@bravo.Page name="TaskInstanceManager" title="待接收任务管理">
	<@bravo.Viewport  layout="border">
		<@bravo.FormPanel name="taskInstance_find" tbar="Toolbar" region="north"  frame="true" autoScroll="true" height="130" width="750"  title="待接收任务列表" collapsible="true"  >  
		...
		<#----
		<@bravo.GridPanel  region="center"   stripeRows="true"  name="taskInstance_grid"  dataProxy="./task!assignTasks.action?isSuspended=0&isOpen=1&actorId_restriction=isNull&pooledActors.actorId=%{requestHandler.currentUser.id?c}"  contextDataName="taskInstances" collapsible="true" >  
		...
		---->
		<@bravo.GridPanel  region="center"   name="taskInstance_grid"  dataProxy="./taskBaseDomain!findAndRendJsonData.action?taskInstance.isSuspended=0&taskInstance.isOpen=1&taskInstance.actorId_restriction=isNull&taskInstance.pooledActors.actorId=%{requestHandler.currentUser.id?c}&taskInstance.end_restriction=isNull" stripeRows="true" contextDataName="taskInstances" collapsible="true" >  
			<@bravo.Column hidden="true" name="id" header="ID" width="176"  sortable="true"  resizable="true"/>
