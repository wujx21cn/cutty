<@bravo.Page name="configItemTemplateManager" title="ConfigItemTemplate管理">
	<@bravo.Viewport  layout="border">
			...
			<@bravo.Toolbar name="Toolbar" valign="top">
				...
				<@bravo.FieldSet labelWidth="80"  cols="1;1;1" rows="1;1;1" >		
					<@bravo.TextField fieldLabel="" name="code" width="165"/>
					<@bravo.TextField fieldLabel="" name="name" width="165"/>
					<@bravo.ComboBox fieldLabel="name" name="configFileId.id" allowBlank="false" editable="false" dataProxy="hql[from ConfigFileTemplate]" displayField="name" valueField="id" />
				</@bravo.FieldSet>
			 </@bravo.FormPanel>    
